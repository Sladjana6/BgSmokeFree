...
<div class="rmp-security rmp-tabcontent" id="rmp-tab-3">
  ...
  <div class="rmp-option-group">
    ...
    <select id="rmp-ip-tracking">
      <option value="1" <?php echo ($rmp_security['ipTracking'] === 1) ? 'selected="selected"':""; ?>>No</option>
      <option value="2" <?php echo ($rmp_security['ipTracking'] === 2) ? 'selected="selected"':""; ?>>Yes</option>
    </select>
    <p class="rmp-notice">
  ...
  <div class="rmp-option-group">
    ...
    <select id="rmp-ip-double-vote">
      <option value="1" <?php echo ($rmp_security['ipDoubleVote'] === 1) ? 'selected="selected"':""; ?>>No</option>
      <option value="2" <?php echo ($rmp_security['ipDoubleVote'] === 2) ? 'selected="selected"':""; ?>>Yes</option>
    </select>
    <p class="rmp-notice">
  ...
  <div class="rmp-option-group">
    ...
    <select id="rmp-user-tracking">
      <option value="1" <?php echo ($rmp_security['userTracking'] === 1) ? 'selected="selected"':""; ?>>No</option>
      <option value="2" <?php echo ($rmp_security['userTracking'] === 2) ? 'selected="selected"':""; ?>>Yes</option>
    </select>
    <p class="rmp-notice">
