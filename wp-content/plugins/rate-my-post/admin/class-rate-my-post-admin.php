...
class Rate_My_Post_Admin {
  ...
  public function menu_section() {
    add_menu_page( 'Rate my Post', 'Rate my Post', 'edit_posts', 'rate-my-post', array($this, 'menu_section_display'), 'dashicons-thumbs-up', 24 );
		...
		add_submenu_page('rate-my-post', 'Rate my Post Settings', 'Settings', 'edit_posts', 'rate-my-post' );
  }
  ...
  public function menu_section_display(){
	...
	public function submenu_stats_section() {
		add_submenu_page( 'rate-my-post', 'Rate my Post Stats', 'Stats', 'edit_posts', 'rate-my-post-stats', array( $this, 'submenu_stats_display' ) );
	}
	...
	public function submenu_analytics_section() {
		add_submenu_page( 'rate-my-post', 'Rate my Post Analytics', 'Analytics', 'edit_posts', 'rate-my-post-analytics', array( $this, 'submenu_analytics_display' ) );
	}
