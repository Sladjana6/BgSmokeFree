...
class Gallery_Photo_Gallery_Admin {
    ...
    public function add_plugin_admin_menu() {
        ...
        $hook_gallery = add_menu_page( __('Gallery - Photo Gallery', $this->plugin_name), __('Gallery - Photo Gallery', $this->plugin_name), 'manage_options', $this->plugin_name, array($this, 'display_plugin_setup_page'), AYS_GPG_ADMIN_URL . 'images/gall_icon.png', 6);
